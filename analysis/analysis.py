...
total_astar_len = [0 for i in range(len(agent))]
for i in range(no_of_tests):
    times, _, movements, examinations, tal = call_agent(agent, GLOBAL_BIG_MAZE_SIZE)
...
for j in range(len(total_time)):
    ...
    print('avg_astar_len: ', total_astar_len[j]/no_of_tests)
